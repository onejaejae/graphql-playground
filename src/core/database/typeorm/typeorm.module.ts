...
import { BoilerConfigModule } from 'src/core/config/config.module';
import { BoilerConfigService } from 'src/core/config/config.service';
...
export class TypeOrmModule {
  static forRoot(): DynamicModule {
    return OrmModule.forRootAsync({
      imports: [BoilerConfigModule],
      inject: [BoilerConfigService],
      useFactory: async (configService: BoilerConfigService) => {
